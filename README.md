...
- Use o comando: `git clone git@github.com:tryber/sd-023-b-project-delivery-app.git`.
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-023-b-project-delivery-app`
...
- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-023-b-project-delivery-app/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-023-b-project-delivery-app/pulls) e confira que o seu _Pull Request_ está criado
...
## ESLint
  ...
  ➡️ Este projeto já vem com as dependências relacionadas ao _linter_ configuradas nos arquivos `package.json` nos seguintes caminhos:
    - `sd-023-b-project-delivery-app/back-end/package.json`
    - `sd-023-b-project-delivery-app/front-end/package.json`
...
- No [protótipo do figma](#construção-do-front-end), existe um número nos elementos associados aos `data-testids`. Você pode, pelo protótipo, identificar o número e depois buscar no arquivo [data-testids.txt](data-testids.txt) pelo `data-testid` correspondente, [como no exemplo](./assets/readme/data-test-figma-txt.png).
...
<details>
  ...
  Link: [Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH23-B&template=betrybe/sd-023-b-project-delivery-app)
